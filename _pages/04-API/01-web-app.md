    ...
    <div class="schema-div"> 
      ...
      <p class="schema-line">
        <span class="schema-key">auth0_id</span>: <span class="schema-string">text</span>; <span class="schema-comment">// not used for clients</span>
            ...
            <p class="schema-line">
        <span class="schema-key">favorites</span>: <span class="schema-string">JSON[]</span>; <span class="schema-comment">// DEFAULT NULL::JSON[]</span>
      </p>
      <p class="schema-line">
        <span class="schema-key">sessions</span>: <span class="schema-string">JSON[]</span>; <span class="schema-comment">// DEFAULT '{}'::JSON[]</span>
      </p>
      <p class="schema-line">
        <span class="schema-key">is_first_login</span>: <span class="schema-boolean">boolean</span>; <span class="schema-comment">// DEFAULT NULL:: boolean</span>
      </p>
      <p class="schema-line">
        <span class="schema-key">active</span>: <span class="schema-boolean">boolean</span>; <span class="schema-comment">// DEFAULT TRUE:: boolean</span>
      </p>
      <p class="schema-line">
        <span class="schema-key">coach_history</span>: <span class="schema-json">JSON[]</span>; <span class="schema-comment">// DEFAULT NULL::JSON[]</span>
        </p>
    </div>
    <h4>Example</h4>
    <pre>
